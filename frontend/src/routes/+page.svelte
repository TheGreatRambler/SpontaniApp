...
<div class="flex flex-col items-center w-full py-24 bg-primary-300">
  ...
  <p>unite through adventure</p>
</div>

<main class="mx-4">
  <div class="my-12">
    <header class="my-4">
      <h2 class="my-2 mt-2 text-black text-3xl font-bold">current destinations</h2>
  ...
  <div class="my-12">
    <header class="my-4">
      <h2 class="my-2 mt-2 text-black text-3xl font-bold">past destinations</h2>
